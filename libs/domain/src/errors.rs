...
impl DomainError {
    ...
    pub fn category(&self) -> &'static str {
        match self {
            ...
            Self::ValidationFailed { .. } | Self::BusinessRuleViolation(_) => "validation",
            ...
            Self::OperationFailed(_) | Self::InvalidStateTransition { .. } => "generic",
        }
    }
}
...
mod tests {
    ...
    fn test_error_categories() {
        ...
        assert_eq!(
            DomainError::UserNotFound("test".to_string()).category(),
            "user"
        );
        assert_eq!(
